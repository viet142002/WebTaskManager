import '@/styles/loaderPencil.css';

interface ILoaderPencil {
    isFixed?: boolean;
}

const LoaderPencil = ({ isFixed }: ILoaderPencil) => {
  return (
      <div className={`${isFixed ? 'fixed' : 'absolute'} inset-0 flex justify-center items-center bg-white/10 dark:bg-black/20 backdrop-blur-[1px]`}>
